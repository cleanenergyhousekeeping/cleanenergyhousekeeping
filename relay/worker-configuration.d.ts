/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66b32035009589f0157832d636535431)
...
interface __BaseEnv_Env {
	...
	CEH_RELAY_APPS_URL: string;
	CEH_RELAY_APPS_HMAC_KEYS_JSON: string;
	CEH_RELAY_TOKEN_HMAC_KEY: string;
	CEH_RELAY_EVENT_DIGEST_HMAC_KEY: string;
	CEH_RELAY_PAYLOAD_ENCRYPTION_KEYS_JSON: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CEH_RELAY_ENVIRONMENT" | "CEH_RELAY_APPS_ACTIVE_KEY_ID" | "CEH_RELAY_PAYLOAD_ACTIVE_KEY_VERSION" | "CEH_RELAY_APPS_URL" | "CEH_RELAY_APPS_HMAC_KEYS_JSON" | "CEH_RELAY_TOKEN_HMAC_KEY" | "CEH_RELAY_EVENT_DIGEST_HMAC_KEY" | "CEH_RELAY_PAYLOAD_ENCRYPTION_KEYS_JSON">> {}
}
